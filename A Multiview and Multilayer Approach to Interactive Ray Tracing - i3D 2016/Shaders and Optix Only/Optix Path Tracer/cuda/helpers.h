...
static 
__device__ __inline__ float degrees(const float radians)
{
...
optix::float3 sample_phong_lobe( optix::float2 sample, float exponent, 
...
static
__host__ __device__ __inline__ 
optix::float3 sample_phong_lobe( const optix::float2 &sample, float exponent, 
...
static
__host__ __device__ __inline__ 
void create_onb( const optix::float3& n, optix::float3& U, optix::float3& V, optix::float3& W )
{
  using namespace optix;
...
static
__device__ __inline__ 
void create_onb( const optix::float3& n, optix::float3& U, optix::float3& V)
{
  using namespace optix;
...
static
__host__ __device__ __inline__ 
optix::float3 differential_transfer_origin(optix::float3 dPdx, optix::float3 dDdx, float t, optix::float3 direction, optix::float3 normal)
{
...
static 
__host__ __device__ __inline__ 
optix::float3 Yxy2XYZ( const optix::float3& Yxy )
{
...
static 
__host__ __device__ __inline__ 
optix::float3 XYZ2rgb( const optix::float3& xyz)
{
...
static 
__host__ __device__ __inline__ 
optix::float3 Yxy2rgb( optix::float3 Yxy )
{
  using namespace optix;
...
static 
__host__ __device__ __inline__ 
optix::float3 rgb2Yxy( optix::float3 rgb)
{
  using namespace optix;
...
static 
__host__ __device__ __inline__ 
optix::float3 tonemap( const optix::float3 &hdr_value, float Y_log_av, float Y_max)
{
  using namespace optix;
