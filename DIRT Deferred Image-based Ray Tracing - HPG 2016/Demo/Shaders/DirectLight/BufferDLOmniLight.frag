...
#include "shadow_mapping_omni_cubemap.h"
...
void main(void)
{
	...
	vec3 dirColor = MicrofacetBRDF(vertex_to_view_direction.xyz, vertex_to_light_direction_ecs.xyz, normal_unclamped.xyz, kd.rgb, specular_params.xyz) * uniform_light_color.rgb /dist2;
