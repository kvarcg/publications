...
void main(void)
{
	//uint total_pixel_counter_uint = atomicCounterIncrement(total_pixel_atomic_counter);
	...
	//out_color = vec4(gl_FragCoord.x - 0.5, gl_FragCoord.y - 0.5, vCurrentLayer, occupancy);
}
