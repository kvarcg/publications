...
// This file contains the fragment implementation for the Mipmap Depth Bounds pass
...
layout(location = 0) out vec4 out_frag_mipmap;					// the new lod of the depth bounds texture
...
void main(void)
{
	...
	out_frag_mipmap = vec4(minZ,maxZ,0,0);
}